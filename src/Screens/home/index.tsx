...
import { FilterModal, FilterButton, FilterSummary } from "../../Components";
  ...
  <View style={styles.offerCard}>
    ...
    <View style={styles.offerContent}>
      ...
      <Text style={styles.offerSub}>
        {item.beds} Beds, {item.baths} Guests
      </Text>
    </View>
...
export function Home(props: any) {
  ...
  const handleFilterApply = (appliedFilters: FilterOptions) => {
    ...
    // Here you would typically filter your properties based on the applied filters
  };
  ...
  const handleRemoveFilter = (
    ...
    if (filterKey === "features" || filterKey === "facilities") {
      ...
      <View style={styles.content}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <PropertyCard
              property={item}
              onPress={() => console.log("Property pressed:", item.title)}
            />
          )}
          showsHorizontalScrollIndicator={false}
        />
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <PropertyCard
              property={item}
              onPress={() =>
                console.log("Trending property pressed:", item.title)
              }
            />
          )}
          showsHorizontalScrollIndicator={false}
